...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your message! I\'ll get back to you soon. (This is a demo - please replace with actual form handling)');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            I'm always excited to discuss new opportunities, collaborations, or just have a friendly chat about technology and innovation
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`p-4 bg-gradient-to-r ${colorClasses.split(' ')[0]} ${colorClasses.split(' ')[1]} rounded-xl group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Fresh Perspective</h4>
                    <p className="text-gray-300 text-sm">As a first-year student, I bring fresh ideas and enthusiasm to every project</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">Passionate about learning new technologies and adapting to challenges</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Collaborative Spirit</h4>
                    <p className="text-gray-300 text-sm">Love working in teams and contributing to innovative solutions</p>
                  </div>
                </div>
              </div>
            </div>
